...
modsList: () => ipcRenderer.invoke('mods:list'),
  ...
  bedrockIntegrityBaselineCapture: () => ipcRenderer.invoke('bedrock:integrityBaselineCapture'),
  bedrockModsBaselineCapture: () => ipcRenderer.invoke('bedrock:modsBaselineCapture'),
  bedrockExperimentalOwnershipFix: () => ipcRenderer.invoke('bedrock:experimentalOwnershipFix'),
